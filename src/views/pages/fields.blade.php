                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="form-group" style="width:10%">
                                ...
                                <a href="{{ url('dataSources/'.$present['component']['data_source_id'].'/edit') }}" class="btn btn-default btn-xs"><span>DS</span></a>
                                <a href="{{ url('components/'.$present['component_id'].'/edit') }}" class="btn btn-default btn-xs"><span>UI</span></a>
