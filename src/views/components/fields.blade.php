...
<script>
    $('#source').on('change', function() {
        var model = $('#source').val();
        console.log(model);
        if(model === 'DataSource') {
            $('#data_source_id').parents('.form-group').show();
            $('#data').parents('.form-group').hide();
        } else {
            $('#data_source_id').parents('.form-group').hide();
            $('#data').parents('.form-group').show();
        }
    });
</script>
@endsection