...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('dataSources.index') !!}" class="btn btn-default">Cancel</a>
</div>
...
<script>
    ...
    $(document).on('change', 'tbody tr .command', function() {
        ...
        getAllColumnAlias($(this), $(this).val() === 'select');
    });
    ...
    $(document).on('change', 'tbody tr .field', function() {
        if($(this).parents('tr').find('.command').val() === 'select') {
            ...
            if($(this).val()) {
                ...
                getAllColumnAlias($(this), !$(this).val());
            }
        }
    });

    function getAllColumnAlias(el, condition) {
        var model = $('#model').val();
