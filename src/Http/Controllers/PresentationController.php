...
class PresentationController extends AppBaseController
{
    ...
    {
        return $presentationDataTable->render('presentations.index');
    }
    ...
    {
        // add by dandisy
        $presentation = \App\Models\Presentation::pluck('page_id')->toArray();
        $page = \App\Models\Page::whereNotIn('id', $presentation)->get();
